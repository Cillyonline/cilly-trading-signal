...
| First paper calibration batch | [First 50-Example Paper Calibration Batch](reviews/first-50-paper-calibration-batch.md) | First structured 50-example paper review and follow-up findings. |
