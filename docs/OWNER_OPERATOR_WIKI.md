...
| Browser smoke automation | [Post-Deploy Browser Smoke Automation Evaluation](POST_DEPLOY_BROWSER_SMOKE_AUTOMATION_EVALUATION.md) | Current decision to keep post-deploy browser smoke manual for now, with safe dry-run contract for any future opt-in script. |
