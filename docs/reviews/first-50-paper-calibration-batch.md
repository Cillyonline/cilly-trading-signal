...
Issue `#481` added explicit paper-batch resistance coverage for both strategy
families: base-breakout resistance compression and trend-pullback resistance
compression now have deterministic No Trade golden cases.
